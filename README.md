...
- Removed class parsing for a future update. (05/01/2026)
- Worked on property set. (06/01/2026)
- Started adding for loop, started adding double-opr assignment. (06/01/2026)
- Continued development on double-opr support. (06/01/2026)
- Continued development on double-opr support. (07/01/2026)
- More parsing on for loops. (07/01/2026)
- Continued development on double-opr support. (08/01/2026)
- Worked on property SET bracket parsing fixes. (09/01/2026)
- Worked on property SET bracket parsing fixes. (09/01/2026)
- Fixed an oversight in property SET bracket. (09/01/2026)
...
- Added GhostScript VS Code extension path (/ghostscript). (10/01/2026)
